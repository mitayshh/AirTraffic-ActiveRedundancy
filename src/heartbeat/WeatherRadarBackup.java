...
public class WeatherRadarBackup {
...
//Constructor
	 public WeatherRadarBackup() throws NamingException,JMSException{
...
System.out.println("Weather Radar 2 has started");
...
{
	System.out.println("Process 2 is sending heartbeat");
	String msg, username = null, password = null;
	WeatherRadarBackup pub;
...
//		num = rand.nextInt((50-1)+1)+1;
		num = rand.nextInt((10-1)+1)+1;
	     ...
	     if(num==5) {
	  	   System.out.println("Process 2 is exiting");
	           //pub.writeMsg("Process Exiting");
	           pub.close();
	          return;
	     } else {
	  	   //System.out.println("Am Alive");
	           pub.writeMsg("Process 2 is Alive");
	     }
	}  //  End of while loop
}
